export const ProjectData = [
    {
        ...
        image: "./images/logo-uic.webp",
        madeAt: "Akabia",
    },
    {
        id: 2,
        title: "Isagri emploi",
        about: "Isagri emploi from the Groupe Isagri (70Millions € Revenue) was the first website I was given to lead the project from scratch. Had to work with another front developer to manage who was doing what, in what order. <br/> Ensured front and back development and speaking directly to the client to plan the next features and schedule it.",
        tags: ['Project management', "Drupal 9", "Full stack", "Agile"],
        demo: "https://emploi.isagri.fr/",
        image: "./images/isagri-logo.webp",
        madeAt: "Akabia",
    },
    {
        id: 3,
        title: "LaShootingBox",
        about: "Worked as a back end developer on this e-commerce Drupal 8 website. <br/>I Had to create the link between a customer and a photograph for them to exchange. <br/> Also generated a cron task to send e-mails, generate pdf with bill details, uploading/downloading the photos.",
        tags: ['Back end', "Drupal 8", "Php/Symfony"],
        demo: "https://www.lashootingbox.com/fr",
        image: "./images/logo-shooting-box.webp",
        madeAt: "HB Digit"
    },
]